...
data() {
  return {
    ...
    headers21: [
      ...
      { label: 'Target Status' ,text: 'Target Status', value: 'b200' , parse: this.makePretty, filterable: false},
      ...
      { label: 'Track Angle Rate (°/s)' ,text: 'Track Angle Rate (°/s)', value: 'b165'  ,filterable: false},
      ...
      { label: 'Aircraft Operational Status' ,text: 'Aircraft Operational Status', value: 'b008',parse: this.makePretty  ,filterable: false },
      { label: 'Surface Capabilities and Characteristics' ,text: 'Surface Capabilities and Characteristics', value: 'b271',parse: this.makePretty  ,filterable: false},
      ...
      { label: 'ACAS Resolution Advisory Report' ,text: 'ACAS Resolution Advisory Report', value: 'b260'  ,filterable: false },
   ...
   headers10: [
      ...
      { label:'Track Status', text: 'Track Status', value: 'a170' , parse: this.makePretty ,filterable: false},
      { label:'Mode-3/A Code in Octal Representation', text: 'Mode-3/A Code in Octal Representation', value: 'a060', parse: this.makePretty},
